...
$(function(){
    ...
    var numOne = document.getElementById('flights');
    ...
    var numSix = document.getElementById('activities');
    var numSeven = document.getElementById('car');
    var addHol = document.getElementById('holiday-sum');
    ...
    var daysThree = document.getElementById('activities-num');
    var daysFour = document.getElementById('car-num');
    var safetyDay = document.getElementById('safety-num');


    var flights = parseFloat(numOne.value);
    ...
    var activities = parseFloat(numSix.value);
    var car = parseFloat(numSeven.value);
    var daysNum = parseFloat(daysOne.value);
    var nightsNum = parseFloat(daysTwo.value);
    var activitiesNum = parseFloat(daysThree.value);
    var carNum = parseFloat(daysFour.value);
    ...
    function add() {
    var flights = parseFloat(numOne.value) || 0;
    var accommodation = parseFloat(numTwo.value) || 0;
    var transport = parseFloat(numThree.value) || 0;
    addHol.value=(flights+accommodation+transport).toFixed(2);

    var days = parseFloat(numFour.value) || 0;
    var nights = parseFloat(numFive.value) || 0;
    var activities = parseFloat(numSix.value) || 0;
    var car = parseFloat(numSeven.value) || 0;
    var daysNum = parseFloat(daysOne.value) || 0;
    var nightsNum = parseFloat(daysTwo.value) || 0;
    var activitiesNum = parseFloat(daysThree.value) || 0;
    var carNum = parseFloat(daysFour.value) || 0;
    var sum = ((days*daysNum)+(nights*nightsNum)+(activities*activitiesNum)+(car*carNum))
...
// - - - - - - - - - - - --  final choice  - - - - - - - - - - - - - - - - -  -  
    ...
    var fin = (function(){
        ...
        $('#fmonths').val(Math.ceil($('#fholiday').val()/$('#fchoose').val()));
    });
